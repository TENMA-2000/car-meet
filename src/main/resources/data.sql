...
(5, '今日は洗車に行ってきた。手洗いの方がいいけど、洗車機は楽でいいね！', '/images/photo2.webp', 'image', false, NULL, '2025-06-25 22:57:48', '2025-06-26 05:57:48', NULL, 80, 44, '洗車', 35.165, 136.974),
...
(5, '朝活ドライブして、誰もいない展望台でコーヒータイム。', '/images/photo5.jpg', 'image', false, NULL, '2025-06-28 22:57:48', '2025-06-29 04:57:48', NULL, 86, 31, '山道の展望台', 35.158, 136.905),
...
(5, '仕事終わりに近くの山へ夜景を見に軽くドライブへ！この静かな時間が好き。', '/images/photo7.webp', 'image', false, NULL, '2025-07-21 22:57:48', '2025-07-22 01:57:48', NULL, 138, 10, '峠道', 35.17, 137.047),
(3, 'ちょっとだけ夜の首都高をひとっ走り。風が気持ちよかった！', '/images/photo8.webp', 'image', false, NULL, '2025-07-22 22:57:48', '2025-07-23 05:57:48', NULL, 200, 20, '高速道路', 35.158, 136.905),
...
(3, 'ガソリン満タンにして、どこまでも走れそうな気分だった。', '/images/photo11.jpg', 'image', false, NULL, '2025-07-19 22:57:48', '2025-07-20 04:57:48', NULL, 137, 12, 'ガソリンスタンド', 35.169, 136.906),
...
(5, 'カフェ巡りドライブ☕静かな森の中にある店で癒された〜。', '/images/photo13.webp', 'image', false, NULL, '2025-06-28 22:57:48', '2025-06-29 10:57:48', NULL, 152, 43, 'カフェ', 35.165, 136.974),
(5, 'ライトアップされた桜並木を見に行ってきた！きれいすぎて感動した～', '/images/photo14.jpg', 'image', false, NULL, '2025-06-26 22:57:48', '2025-06-27 04:57:48', NULL, 119, 37, '公園', 35.158, 136.905),
...
(3, '少し眠たいのでパーキングエリアで一休み。長距離移動はやっぱり疲れるな～(;´∀｀)', '/images/photo18.webp', 'image', false, NULL, '2025-07-05 22:57:48', '2025-07-06 00:57:48', NULL, 114, 18, 'パーキングエリア', 35.130, 136.907),
...
(1, 3, NULL, '参考になりました、ありがとうございます！', '2025-08-25 12:10:00', '2025-08-25 12:10:00', NULL),
(1, 4, 1, 'ほんとですね！私も同じ意見です！', '2025-08-25 12:15:00', '2025-08-25 12:15:00', NULL),

-- 投稿2
(2, 2, NULL, '質問なのですが、この方法はどの環境でも使えますか？', '2025-08-26 09:00:00', '2025-08-26 09:00:00', NULL),
(2, 3, NULL, 'このコメントは削除されました。', '2025-08-26 09:30:00', '2025-08-26 10:00:00', '2025-08-27 08:00:00'),

-- 投稿3
(3, 5, NULL, '初めて知りました！やってみます！', '2025-08-25 14:00:00', '2025-08-25 14:00:00', NULL),
(3, 2, 6, 'ぜひ試してみてください！おすすめです。', '2025-08-25 14:05:00', '2025-08-25 14:05:00', NULL),

-- 投稿4
(4, 4, NULL, 'この部分、もう少し詳しく説明してもらえますか？', '2025-08-25 15:00:00', '2025-08-25 15:00:00', NULL),

-- 投稿5
(5, 3, NULL, '面白い発想ですね！勉強になります。', '2025-08-25 16:00:00', '2025-08-25 16:00:00', NULL),
(5, 6, NULL, '確かに新しい視点だと思いました。', '2025-08-25 16:10:00', '2025-08-25 16:10:00', NULL),

-- 投稿6
(6, 2, NULL, 'ありがとうございます！助かりました。', '2025-08-25 17:00:00', '2025-08-25 17:00:00', NULL),
(6, 4, 11, '同感です！', '2025-08-25 17:05:00', '2025-08-25 17:05:00', NULL),

-- 投稿7
(7, 5, NULL, 'このやり方だと効率が上がりそうですね。', '2025-08-26 10:00:00', '2025-08-26 10:00:00', NULL),

-- 投稿8
(8, 6, NULL, 'わかりやすくて助かります！', '2025-08-26 11:00:00', '2025-08-26 11:00:00', NULL),
(8, 3, 15, '本当にわかりやすかったですよね。', '2025-08-26 11:05:00', '2025-08-26 11:05:00', NULL),

-- 投稿9
(9, 2, NULL, 'これは素晴らしい情報です。感謝します。', '2025-08-26 12:00:00', '2025-08-26 12:00:00', NULL),
(9, 5, NULL, '削除済みコメント', '2025-08-26 12:10:00', '2025-08-26 12:20:00', '2025-08-27 09:00:00'),

-- 投稿10
(10, 4, NULL, 'なるほど！目から鱗でした。', '2025-08-26 13:00:00', '2025-08-26 13:00:00', NULL),
(10, 6, 18, '私もそう思います！', '2025-08-26 13:05:00', '2025-08-26 13:05:00', NULL);