...
(60, 1, 4, 58, 'ほんとですね！私も同じ意見です！', '2025-08-25 12:15:00', '2025-08-25 12:15:00', NULL),
...
(64, 3, 2, 63, 'ぜひ試してみてください！おすすめです。', '2025-08-25 14:05:00', '2025-08-25 14:05:00', NULL),
...
(68, 6, 4, 67, '同感です！', '2025-08-25 17:05:00', '2025-08-25 17:05:00', NULL),

-- 投稿7
(69, 7, 5, NULL, 'このやり方だと効率が上がりそうですね。', '2025-08-26 10:00:00', '2025-08-26 10:00:00', NULL),

-- 投稿8
(70, 8, 3, NULL, '本当にわかりやすかったですよね。', '2025-08-26 11:05:00', '2025-08-26 11:05:00', NULL),
...
(74, 10, 5, 73, '私もそう思います！', '2025-08-26 13:05:00', '2025-08-26 13:05:00', NULL);

/* talk_rooms */
INSERT IGNORE INTO talk_rooms (
    talk_room_id,
    name,
    owner_user_id,
    created_at,
...
(1, '初マイカールーム', 1, '2025-09-16 10:00:00', '2025-09-16 10:00:00', NULL),
(2, 'ロードスターオーナーズルーム', 2, '2025-09-16 11:00:00', '2025-09-16 11:00:00', NULL),
(3, 'セダン専門ルーム', NULL, '2025-09-16 12:00:00', '2025-09-16 12:00:00', NULL);

/* talk_room_participantsテーブル */
INSERT IGNORE INTO talk_room_participants (
    participant_id,
    talk_room_id,
    user_id,
    joined_at,
...
(1, 1, 1, '2025-09-16 10:05:00', NULL), -- ルーム1にオーナーが参加
(2, 1, 2, '2025-09-16 10:06:00', NULL), -- ルーム1にユーザー2が参加
(3, 1, 3, '2025-09-16 10:10:00', '2025-09-16 11:00:00'), -- ルーム1にユーザー3が参加後退出
(4, 2, 2, '2025-09-16 11:10:00', NULL), -- ルーム2にオーナー（ユーザー2）が参加
(5, 2, 4, '2025-09-16 11:20:00', NULL), -- ルーム2にユーザー4が参加
(6, 3, 5, '2025-09-16 12:05:00', NULL); -- ルーム3にユーザー5が参加 

/* talk_room_messagesテーブル */
INSERT IGNORE INTO talk_room_messages (
    message_id,
    talk_room_id,
    sender_user_id,
    content,
...
-- ルーム1の会話
(1, 1, 1, 'はじめまして！初心者ですがよろしくお願いします！', '2025-09-16 10:15:00', NULL, FALSE, NULL),
(2, 1, 2, 'こちらこそ！どんな車に乗ってますか？', '2025-09-16 10:16:00', NULL, FALSE, 1),
(3, 1, 1, 'ロードスターに乗っています！', '2025-09-16 10:17:00', NULL, FALSE, 2),

-- ルーム2の会話（画像添付例）
(4, 2, 2, '昨日のツーリングの写真をアップします！', '2025-09-16 11:30:00', '/uploads/touring1.jpg', FALSE, NULL),
(5, 2, 4, 'わー！かっこいいですね！', '2025-09-16 11:32:00', NULL, FALSE, 4),

-- ルーム3の会話（削除済みメッセージ例）
(6, 3, 5, 'ここはゼロクラウンオーナー専用ルームです！', '2025-09-16 12:10:00', NULL, TRUE, NULL);