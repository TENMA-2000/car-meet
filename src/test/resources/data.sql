...
/* usersテーブル */
-- ユーザー1: 一般ユーザー
INSERT IGNORE INTO users (name, email, password, phone_number, profile_image, car_life_year, gender, introduction, hobbies, enabled, role_id) VALUES ('山田太郎', 'taro.yamada@example.com', '$2b$12$Saa1wkIQnqNeZi.1sfvPTei87rVxjsJhwptAuT0BNlNeUQS0hfcVy', '09012345678', 'https://example.com/profile/taro.jpg', 5, 0, 'ドライブと洗車が趣味です。', 'ドライブ,洗車,写真', TRUE, 1);

-- ユーザー2: 管理者ユーザー
INSERT IGNORE INTO users (name, email, password, phone_number, profile_image, car_life_year, gender, introduction, hobbies, enabled, role_id) VALUES ('佐藤花子', 'hanako.sato@example.com', '$2b$12$mRUf95hFk6xkVYoiJKZvcO7mivuOt4Uo3lmDr0VE/ytm.fdmbNMRy', '08098765432', 'https://example.com/profile/hanako.png', 10, 1, '車のイベント企画が好きです。', 'イベント企画,カフェ巡り', TRUE, 2);
